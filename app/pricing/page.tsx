    ...
    <div className="relative min-h-screen overflow-hidden bg-gradient-to-br from-background via-background to-muted/30">
      ...
      <div className="relative z-10 container mx-auto max-w-7xl px-6 py-16 sm:px-8 lg:px-10">
        ...
        >
          ...
          >
            <SynapseIcon className="size-10 text-primary transition-transform duration-300 group-hover:scale-110" />
            <span className="font-display text-2xl font-bold tracking-tight text-foreground transition-colors duration-300 group-hover:text-primary">
              Synapse
            </span>
          </Link>
        </motion.div>
